...
import DashboardNavbar from "examples/Navbars/RootNav";
...
function Dashboard() {
  ...
  // Fetch resolved complaints (those accepted by artisan)
  useEffect(() => {
    const fetchResolvedComplaints = async () => {
      try {
        ...
        setResolvedComplaintsCount(resolvedComplaintsSnapshot.size); // Set the resolved complaints count
      } catch (error) {
